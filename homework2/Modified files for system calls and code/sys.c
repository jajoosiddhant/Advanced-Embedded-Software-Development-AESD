...
*/
SYSCALL_DEFINE3(mycall, int32_t*,arr,int32_t,length,int32_t*,sorted_arr)
{
...
for (i=0; i<length;i++)
{
printk("Kernel Space Random number at Position %d is %d.\n", i, buff[i]);
}
...
printk("Copying contents from kernel space to user space:\n");

if(copy_to_user(sorted_arr, buff, number_byte))
{ 
printk("Error!\n");
return -EFAULT;
}
